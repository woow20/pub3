...
if($rand_bot_number > $rand_bot_win_num) {
  ...
  $bot = "INSERT INTO `engmn_games` (`id`, `user_id`, `login`, `number`, `cel`, `sum`, `chance`, `type`, `win_summa`) VALUES (NULL, '1', '$logbot', '$rand_bot_number', '$rand_bot_cel', '$rand_bot_bet', '$rand_bot_per', '$rand_bot_type_game', '$rand_bot_sum');";
  mysql_query($bot);
  }
