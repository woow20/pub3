...
<!-- MODAL -->
    ...
    <hr>
    <p>Логин
<input type='text' class='input-bordered col-12' id='username' value='Владимир Кот'></p><br>
    <p>Пароль
<input type='text' class='input-bordered col-12' id='userpass' value='1212121212'></p><br>
    <p>Баланс
<input type='text' class='input-bordered col-12' id='userbal' value='500.00'></p><br>
    <p>Подкрутка
