...
if($type == "save_edit") {
  ...
  if($check_adm == 1) {
    ...
    $update_sql18 = "Update engmn_config set min_per = '$minper'";
      mysql_query($update_sql18);
    $update_sql19 = "Update engmn_config set max_per = '$maxper'";
      mysql_query($update_sql19);
    $update_sql20 = "Update engmn_config set fake_online = '$fakeonline'";
      mysql_query($update_sql20);
    $update_sql21 = "Update engmn_config set fake_interval = '$fakeinterval'";
      mysql_query($update_sql21);
    $update_sql22 = "Update engmn_config set min_sum_dep = '$mindep'";
...
$update_sql1 = "Update engmn_user set login = '$new_log' WHERE id='$id'";
      mysql_query($update_sql1);
$update_sql2 = "Update engmn_user set pass = '$new_pass' WHERE id='$id'";
      mysql_query($update_sql2);
